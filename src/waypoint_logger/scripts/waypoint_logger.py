...
home = expanduser('~')
#file = open(strftime(home+'catkin_ws/src/lab6/rcws/logs/wp-%Y-%m-%d-%H-%M-%S',gmtime())+'.csv', 'w')
file_path = join(home, 'catkin_ws/src/lab6/rcws/logs')
file_name = strftime('wp-%Y-%m-%d-%H-%M-%S.csv', gmtime())
file_pathname = join(file_path, file_name)
